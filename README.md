<img src="https://github.com/emmanueldev247/emmanueldev247/blob/main/my_readme_header.gif" alt="Header" width="100%">
...
- 🌆 **[Radiance Smart City](https://github.com/emmanueldev247/radiance-smart-city)** *(🏅1st Place)* – A smart city IoT project featuring **RFID access control**, **smart lighting**, and **fire/flood alerting** via **SMS**/call notifications  
- 🗑️ **[Starfield EcoBin](https://github.com/emmanueldev247/starfield-ecobin)** *(🏅1st Place)* – A motion-activated **smart waste bin** with **fill-level sensing**, designed to optimize waste management in urban areas  
